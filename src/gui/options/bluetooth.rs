// GUI/OPTIONS/BLUETOOTH
// DRAW A SETTINGS PAGE FOR BLUETOOTH ON/OFF
    ...
    critical_section::with(|_cs| unsafe {
            ...
            core::ptr::addr_of!(HIT_AREA).read().as_ref()
        {
            if crate::gui::hit_test(x, y, area) {
                let is_on = crate::load!(crate::state::BLUETOOTH_STATE);
                crate::store!(crate::state::BLUETOOTH_STATE, !is_on);
...
pub fn draw(fb: &mut crate::components::framebuffer::Framebuffer) {
    ...
    let icon_bytes = if is_on {
        crate::base::assets::SETTINGS_BLUETOOTH_PNG
    } else {
        crate::base::assets::SETTINGS_BLUETOOTH_PNG
    };
