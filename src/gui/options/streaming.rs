// GUI/OPTIONS/STREAMING
// DRAW A SETTINGS PAGE FOR TOGGLE NETWORK AUDIO STREAMING (SPEAKER) ON/OFF
    ...
    critical_section::with(|_cs| unsafe {
            ...
            core::ptr::addr_of!(HIT_AREA).read().as_ref()
        {
            if crate::gui::hit_test(x, y, area) {
                ...
                let is_on: bool = crate::load!(crate::state::SPEAKER_ALLOW_STREAMING);
                defmt::info!("Streaming state: {}", !is_on);
                crate::store!(crate::state::SPEAKER_ALLOW_STREAMING, !is_on);
